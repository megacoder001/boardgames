...
const img = new Image();
const img.src = '../../images/gamesimages/tictactoeimages/tictactoeprocessingimages/redcross01.png';
		...
		for (let ind = 0; ind < this.boardState.cellStates.length; ind++) {
			...
			if (value == CellState.EMPTY) {
				...
				img.addEventListener('load', () => {
					ctx.drawImage(img.src, 0, 0, 200, 200); // Draw the image at coordinates (0, 0)
				});
